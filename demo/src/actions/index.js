...
export const redirectToPassengerHome = () => ({
  type: ACTIONS.REDIR_PASSENGER_HOME
});

export const redirectToPassengerIdForm = () => ({
  type: ACTIONS.REDIR_PASSENGER_ID_FORM
});

export const redirectToPassengerIdFormSubmit = () => ({
  type: ACTIONS.REDIR_PASSENGER_ID_FORM_SUB
});
