...
import {
  REDIR_PASSENGER_HOME,
  REDIR_PASSENGER_ID_FORM,
  REDIR_PASSENGER_ID_FORM_SUB,
  REDIR_CITY_HOME,
  REDIR_CITY_ID_FORM,
...
function redirectToPassengerHome() {
  history.push("/passenger");
}

function redirectToPassengerIdForm() {
  history.push("/passenger/personalinfo");
}

function redirectToPassengerIdFormSubmit() {
  history.push("/passenger/submitted");
}
...
function redirectToDiplomaHome() {
  history.push("/selfservice/enrollment");
}

function redirectToDiplomaRequirement() {
  history.push("/selfservice/enrollment/prerequisites");
}

function redirectToReceiveDiploma() {
  history.push("/selfservice/enrollment/receive");
}

function redirectToDiplomaReceived() {
  history.push("/selfservice/enrollment/complete");
}
...
export default function* handleRedirects() {
  yield spawn(takeEvery, REDIR_PASSENGER_HOME, redirectToPassengerHome);
  yield spawn(takeEvery, REDIR_PASSENGER_ID_FORM, redirectToPassengerIdForm);
  yield spawn(takeEvery, REDIR_PASSENGER_ID_FORM_SUB, redirectToPassengerIdFormSubmit);
