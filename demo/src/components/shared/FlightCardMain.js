...
import Tooltip from "./FlightCardTooltip";
        ...
        <Grid>
            ...
            <Issuer>
              <Header>
                ...
                <Header.Sub>
                  <span>Includes</span>{" "}
                  <Tooltip
                    display={`7 credential${receiveClaims.length > 0 ? "s" : ""}`}
          ...
          <Col span={10}>
            ...
            {shareServices.length
              ...
              <CapsuleLinkButton to="/enrollment" onClick="onClickButton">
...
export default connect(undefined, mapDispatchToProps)(FlightCard);
