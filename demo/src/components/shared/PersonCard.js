        ...
        <Grid>
          <Col span={7}>
            <Issuer>
              ...
              <Description>Is above 18: YES</Description>
              <Description>Destination airport: VNO</Description>
                          <Attention>
            GDPR Deletion date: 2019.04.04.<br/>
            Please note, that the will be deleted automatically.
            </Attention>
            </Issuer>
          </Col>
          <Col span={5}>
            <Issued><br/><br/><br/><br/>
             {isApproaching &&
                <h2>ATTENTION! <br/>USER IS APPROACHING</h2>
              }
