          ...
          <Col span={7}>
            <Issuer>
              <Header>
                ...
                <Header.Sub>
                  <span>Revocation date: 2019.04.29</span>{" "}
                </Header.Sub>
              </Header>
              <Description>Please note that on the revocation date the data processing party will have to delete all of the data associated with your profile.</Description>
            </Issuer>
          </Col>
          <Col span={5}>
            <Issued>
            {shareServices.length
              ...
              <Button onClick={this.promptAndRedirect}>
                Revoke permission ASAP.
                <img src={popupIcon} alt="" />
              </Button>
              <Description>Was the data deleted? NO</Description>
            </Issued>
          </Col>
        </Grid>
      </Content>
