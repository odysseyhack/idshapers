  ...
  render() {
    return (<Hero>
      <Hero.Welcome>
        ...
        <h2>Welcome to</h2>
        <h1>Schipol Airport</h1>
        <p>Open your mobile app and check in at the airport.</p>
        <p>Start with a seamless happy passenger flow.</p>
        <CapsuleLinkButton to="/selfservice/enrollment">Get Started</CapsuleLinkButton>
      </Hero.Welcome>
    </Hero>);
  }
}
